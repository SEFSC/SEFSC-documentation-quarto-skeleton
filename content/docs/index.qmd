...
Application documention goes here. Use as many Markdown files and subdirectories as necessary to capture and organize all necessary information. See the section [HOWTO: Using the SEFSC Quarto Theme](../howto/) for instructions on creating, populating, and using this template.
