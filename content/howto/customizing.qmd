...
Download and install [Quarto](https://quarto.org/docs/get-started/){target="_blank"} and a code editor of choice. Follow the instructions for previewing the website within your chosen code editor (*e.g.*, [VS Code](https://quarto.org/docs/get-started/hello/vscode.html){target="_blank"}).
