---
title: Rendering
subtitle: Exploring some features of Quarto
order: 14
---

This repo includes a GitHub Action that will render (build) the website automatically when you make changes to the files. It will be pushed to the `gh-pages` branch.
