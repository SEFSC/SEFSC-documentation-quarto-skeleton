...
1. Browse to the [SEFSC-documentation-quarto-skeleton](https://github.com/MattGrossi-NOAA/SEFSC-documentation-quarto-skeleton){target="_blank"} repository, select the "Use this template" button, and select "Create a new repository": ![GitHub use template image](https://ioos.github.io/use-template.png)
